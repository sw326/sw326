...
풀스택 개발자입니다. 백엔드(Spring Boot)와 프론트엔드(React/Next.js), 모바일(Flutter)을 넘나들며 서비스를 만들고, AI를 엮어서 반복 작업을 자동화하는 걸 좋아합니다.
...
**AI**
<br/>
<img src="https://img.shields.io/badge/Claude-D97757?style=for-the-badge&logo=anthropic&logoColor=white" /> <img src="https://img.shields.io/badge/Gemini-8E75B2?style=for-the-badge&logo=google-gemini&logoColor=white" />
...
**안녕 (Annyeong)** — 시니어 인지 건강 평가 플랫폼
> 시니어가 직접 인지 평가를 수행하고, 보호자가 실시간으로 모니터링하는 헬스케어 서비스. 기억력·공간·언어·주의력 등 6개 도메인 15문항 평가, AI 피드백, WebSocket 기반 실시간 대시보드 구현.
...
![Flutter](https://img.shields.io/badge/Flutter-02569B?style=flat-square&logo=flutter&logoColor=white) ![Spring Boot](https://img.shields.io/badge/Spring_Boot-6DB33F?style=flat-square&logo=spring-boot&logoColor=white)

---

### 🌱 Personal

**[Financial Dashboard](https://chumji-finance.vercel.app)** — 실시간 금융 대시보드 · [repo](https://github.com/sw326/financial-dashboard)
